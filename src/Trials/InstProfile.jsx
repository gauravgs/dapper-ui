...
import DrawerRHS from "./DrawerRHS";

class InstProfile extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
        ...
        <Grid container>
          ...
          <Grid item md={5}>
            ...
            >
              <Grid container>
                <Grid item md={1}>
                  <Avatar style={{ margin: "15px", backgroundColor: "red" }}>
                    <MailIcon />
                  </Avatar>
                </Grid>
                <Grid item md={10}>
          ...
          <Grid item md={5}>
            ...
            >
              <Grid container>
                <Grid item md={1}>
                  <Avatar
                    style={{ margin: "15px", backgroundColor: "#0091ea " }}
                  >
                    <MailIcon />
                  </Avatar>
                </Grid>
