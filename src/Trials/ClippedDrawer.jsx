          ...
          <Grid container>
            <List>
              <ListItem
                ...
                style={{ width: "355px", color: "#3F51B5" }}
              >
                <ListItemAvatar>
                  <FolderIcon />
                </ListItemAvatar>
              ...
              <ListItem button style={{ width: "355px", color: "#3F51B5" }}>
                <ListItemAvatar>
                  <MailIcon />
                </ListItemAvatar>
              ...
              <ListItem button style={{ width: "355px", color: "#3F51B5" }}>
                ...
                <ListItemText>Extra Field !!!!</ListItemText>
              </ListItem>
            </List>
          </Grid>
        </Card>
